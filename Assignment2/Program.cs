    ...
    class Program
    {
        ...
        */
        ...
        public static int SearchInsert(int[] nums, int target)
        {
            ...
            {
                /*
                 *I've applied the concept of binary search.
                 *I've set a minimum and maximum limit of the index and have calculated the middle.
                 *If middle of the array is the target number, I return mid.
                 *In case the value of targer is greater, I change the max value as  mid – 1 and while if it's smaller we change the value
                 *of min as mid + 1
                 */

                //will store the required index and stores the min limit
                int min = 0;
                //stores max limit
